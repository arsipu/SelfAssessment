    ...
    <div v-else class="space-y-6">
      ...
      >
        ...
        <div class="border-t border-gray-100">
          <!-- Form aktif -->
          <div v-if="activeAddCategoryId === cat.id" class="px-5 py-4 bg-gray-50">
            <div class="flex items-start gap-3">
              <textarea
                v-model="inlineForm.question"
                rows="2"
                class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-sm resize-none"
              ...
              <div class="flex flex-col gap-2 pt-1 shrink-0">
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="radio" v-model="inlineForm.favorable" value="favorable" class="h-4 w-4" />
                  <span class="text-sm text-gray-700 whitespace-nowrap">Favorable</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="radio" v-model="inlineForm.favorable" value="unfavorable" class="h-4 w-4" />
          ...
          <button
            ...
            class="w-full px-5 py-3 text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-2"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 flex flex-col max-h-[90vh]">
        ...
        <div class="p-6 space-y-4 overflow-y-auto">
          ...
          <div class="flex gap-4">
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="radio" v-model="editForm.favorable" value="favorable" class="h-4 w-4" />
              <span class="text-sm text-gray-700">Favorable</span>
            </label>
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="radio" v-model="editForm.favorable" value="unfavorable" class="h-4 w-4" />
