<template>
	<div>
								...
								<div class="relative inline-block">
									...
									>
										<span
											...
											:class="statusDotClass(likert.status)"
										></span>
				...
				>
					<div>
						...
						<p class="text-xs text-text-muted mt-0.5">
							{{
								isEditing
									? "Ubah nama atau deskripsi formulir."
									: "Buat formulir survei baru."
							}}
						</p>
					</div>
					<button
		...
		>
			Apakah Anda yakin ingin menghapus formulir ini? Semua data terkait —
			termasuk kategori, pertanyaan, skala penilaian, dan submission —
