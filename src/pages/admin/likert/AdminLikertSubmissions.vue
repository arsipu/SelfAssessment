        ...
        <table class="app-table w-full text-left border-collapse">
          <thead>
            <tr>
              ...
              <th class="px-4 md:px-5 py-3 text-xs font-medium uppercase tracking-wider">Kelas</th>
              ...
              <th class="px-4 md:px-5 py-3 text-xs font-medium uppercase tracking-wider">Skor</th>
