				...
				<div class="flex items-start gap-3">
					...
					<div>
						...
						<p class="text-xs text-warning-80 mt-1">
							Skor dan kode RIASEC belum tersedia karena responden masih dalam
							tahap mengerjakan kuesioner. Jawaban yang sudah masuk tetap
...
/**
 * Memetakan data submission (Firestore) ke bentuk result yang dipakai HollandResult.
 *
 * @returns {{ code: string, respondent: { name: string, major: string, school: string, gender: string, age: number, occupation: string, testPurpose: string }, answers: Array } | null}
 */
