...
const routes = [
	...
	{
		path: "/holland/:slug/questions",
		name: "holland-questions",
		component: HollandQuestions,
	},
	{
		path: "/holland/:slug/result",
		name: "holland-result",
		component: HollandResult,
	},

	// Likert — parameterized by :slug
	{ path: "/likert/:slug", name: "likert-form", component: LikertForm },
	{
		path: "/likert/:slug/questions",
		name: "likert-questions",
		component: LikertQuestions,
	},
	{
		path: "/likert/:slug/result",
		name: "likert-result",
		component: LikertResult,
	},
