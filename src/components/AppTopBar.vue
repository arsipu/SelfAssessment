						...
						>
							...
							>
								...
								<div>
									...
									<p v-if="item.description" class="text-xs text-text-muted">
										{{ item.description }}
									</p>
								</div>
							</router-link>
...
const handleClickOutside = (e) => {
	if (
		instrumentDropdownRef.value &&
		!instrumentDropdownRef.value.contains(e.target)
	) {
